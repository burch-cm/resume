...
details <- tribble(
  ~ Company, ~ Info,
  "The MITRE Corporation", "Co-Principal Investigator (PI) for a multi-year research project focused on improving outcomes and effiency in the US Veterans' Affairs disability awards process. Designed, budgeted, and staffed the team. Conducted analysis of results at all relevant times, and changed strategy when necessary based on project needs.",
  
  "The MITRE Corporation", "Designed and coded a
  comprehensive metaanalysis of Alzheimer's Disease and Related Eementias (ADRD), 
  ...
  "The MITRE Corporation", "Trained data analysts and mentored junior data scientists HOW MANY 
  in statatiscal techniques WHICH ONES, complex systems modeling, simulation methods WHICH ONES, 
  and data analysis best practices.",
  
  "The MITRE Corporation", "Lead a baseline testing team OF HOW MANY and served as the 
  epidemiology modeling expert for the DARPA Automated Scientific Knowledge 
  Extraction and Modeling (ASKEM) evaluation from YEAR TO YEAR.", 
