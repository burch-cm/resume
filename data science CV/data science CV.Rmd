...
company <- tribble(
  ...
  "2022 - present", "Lead Data Scientist", "MITRE",
...
details <- tribble(
  ~ Company, ~ Info,
  "MITRE", "Co-Principal Investigator (PI) for an internal research and development 
  project regarding the assessment of veterans benefits. Developed analysis plans, 
  conducted research, analyzed results, and presented findings from a multi-year project.", 
  "MITRE", "Subject matter expert in R programming language. Mentored researchers, junior data 
  scientists, and data analysists in R and data analysis best practices.",
  "MITRE", "Built systems dynamics and agent-based models to analyze complex systems across 
  multiple domains. Utilized advanced machine learning techniques to model physical, 
  sociological, and epidemiological systems.",
  "MITRE", "Developed company-interal software libraries for machine learning, survey analysis, 
  and data visualization.",
  "MITRE", "[Data Visualization]",
  "MITRE", "[Survey/Equity Analysis]",
  "MITRE", "[ADRD Metaanalysis]",
  "MITRE", "[IR Sensor Modeling]",
...
tribble(
    ~ Name, ~ Org,
    "Certified Professional Property Specialist (CPPS)", "National Property Management Association",
